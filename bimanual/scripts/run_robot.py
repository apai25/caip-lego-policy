...
# @hydra.main(version_base=None, config_name="config", config_path="/home/ilija/code/mvp_generalize/mvp-generalize-yoloworld-sam2/bimanual/test_config")
def run_robot():
    # Load YAML file as DictConfig
